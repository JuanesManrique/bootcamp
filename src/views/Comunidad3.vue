<template lang="">
    <div class="Video p-4">
        <div class="video-container w-full flex justify-center mb-3">
            <video class="rounded" src="https://camilo9497.github.io/videos-alcaldia/assets/21-06-01%20HISTORIA%20VICTOR%20SANTA%20F%C3%89.mp4" controls ></video>
        </div>
        <div class="description-container mb-5">
            <div class="">
                <div>
                    <h1 class="font-bold mb-4" style="font-size: 20px; color: #2B5AC4;">Apoyo a la comunidad barrio Santa fe, aprendizaje de ornamentacion y soldadura</h1>
                </div>
                <div>
            ...
            <div class="row comentarios justify-content-center">
                <div class="col-12">
                    <form action="" class="form_comentarios d-flex justify-content-end flex-wrap">
                        <textarea name="" id="" placeholder="Comentario" class="rounded mb-4"></textarea>
...
.mediabody .nombre span {
    font-size: 12px;
    color: #464646;
    margin-left: 10px;
}
.mediabody .comentario {
    margin-top: 10px;
}
.botones {
    display: flex;
